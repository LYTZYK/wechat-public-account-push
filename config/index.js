export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "hpjKw0EkcJ90cBcrSDOAfXX953Vh4wCcDKo4LyM8L4Q",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "307826b08982ffc08fd34eb030a033f7",
  ...
  USERS: [
    {
      ...
      id: "oGhCa6HLCrl54RV-JYJZpOhahHD0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "hpjKw0EkcJ90cBcrSDOAfXX953Vh4wCcDKo4LyM8L4Q",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "德阳",
